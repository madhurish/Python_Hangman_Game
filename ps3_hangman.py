...
def isWordGuessed(secretWord, lettersGuessed):
    ...
    for letter in lettersGuessed:
        if letter in secretWord:
            secretWord = str(secretWord).replace(letter,"")
    if len(secretWord) == 0:
        return True
    else:
       return False
...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    for letter in tempList:
        if letter in lettersGuessed:
            ...
            tempWord = tempWord.replace(letter,'_')
    return tempWord
    ...
    * After each round, you should also display to the user the 
    ...
    while isWordGuessed(secretWord,lettersGuessed) is False:
        ...
        if(count>0):
            ...
            lettersGuessed.append(currentGuess.lower())
            if(isWordIn(secretWord,list(currentGuess))):
